...
/* Typography */
.fl-node-<?php echo $id; ?> .bb-expandable-trigger-row {
<?php if( $settings->bber_font['family'] != 'Default' ):?>
	font-family:"<?php echo $settings->bber_font['family']; ?>";
	font-weight:<?php echo ( $settings->bber_font['weight'] == 'regular' || $settings->bber_font['weight'] == '' ) ? 'normal' : $settings->bber_font['weight'] ; ?> ;
<?php endif?>
...
/* Content Typography */
.fl-node-<?php echo $id; ?> .bber-content {
<?php if( $settings->bber_content_type == 'content' && $settings->bber_content_font['family'] != 'Default' ): ?>
	font-family:<?php echo $settings->bber_content_font['family']; ?> ;
	font-weight:<?php echo $settings->bber_content_font['weight']; ?> ;
<?php endif ?>
	font-size:<?php echo ($settings->bber_content_font_size == '' ) ? '18' : $settings->bber_content_font_size ?>px;
	line-height:<?php echo ($settings->bber_content_line_height == '' ) ? '22' : $settings->bber_content_line_height ?>px;
}
