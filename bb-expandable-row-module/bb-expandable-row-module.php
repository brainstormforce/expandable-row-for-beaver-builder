				...
				'content'	=>	array(
					...
					'fields'=> array(
						...
						'bber_content_type'				=> array(
							...
							'toggle'					=> array(
								'content'				=> array(
									'fields'			=> array('bber_desc_align','bber_editor','bber_typo_content_color','bber_content_font','bber_content_font_size','bber_content_line_height')
								),
								'photo'					=> array(
						...
						// content font typography
						'bber_content_font'	=> array(
							'type'			=> 'font',
							'label'			=>	__('Description Typography', 'bb-expandable-row'),
							'default'		=> array(
                            	'family'	=> 'Defaults',
                            	'weight'	=> 'Defaults'
							),
							'preview'		=> array(
                            	'type'		=> 'font',
                            	'selector'	=> '.bber-content'  
                        	)
						),
						// Font Size
                        'bber_content_font_size'=> array(
	                        'type'				=> 'text',
	                        'label'				=> __('Description Font Size', 'bb-expandable-row'),
	                        'placeholder'		=> '18',
	                        'maxlength'			=> '3',
	                        'size'				=> '3',
                        	'description'		=> __('px','bb-expandable-row'),
                    	...
                    	// Line Height
                    	'bber_content_line_height'	=> array(
	                        'type'					=> 'text',
	                        'label'					=> __('DescriptionLine Height', 'bb-expandable-row'),
	                        'placeholder'			=> '22',
	                        'maxlength'				=> '3',
	                        'size'					=> '3',
	                        'description'			=> __('px','bb-expandable-row'),
