...
(function($) {
	...
	<?php if( $row->settings->er_icon_position == 'left' ): ?>
	 ...
	 <?php endif ?>
	<?php endif ?>
	 html += '<span class="bb-er-title"><?php echo ($row->settings->er_bc_title); ?></span>';
	...
	$('.fl-node-<?php echo $row->node; ?> .bb-er-row').click(function() {
		...
		// toggle title
		( $('.fl-node-<?php echo $row->node; ?>  .bb-er-title').text() == '<?php echo ($row->settings->er_bc_title); ?>' ) ? $('.fl-node-<?php echo $row->node; ?>  .bb-er-title').text('<?php echo ($row->settings->er_ac_title); ?>') : $('.fl-node-<?php echo $row->node; ?>  .bb-er-title').text('<?php echo ($row->settings->er_bc_title); ?>');
